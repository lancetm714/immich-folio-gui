    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          background: open ? 'linear-gradient(135deg, #f43f5e, #a855f7)' : 'rgba(30,30,30,0.9)',
        ...
        >
          ...
          <Section title="Grid">
            <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
              <label style={{ color: '#71717a', fontSize: 11, minWidth: 45 }}>
                Cols: {gridCols}
              </label>
              <input
                type="range"
          ...
          >
            <button
              ...
              style={{
                ...
                border: 'none',
                background:
                  copiedYaml === 'all' ? '#22c55e' : 'linear-gradient(135deg, #a855f7, #6366f1)',
                color: '#fff',
                fontWeight: 600,
                fontSize: 12,
                cursor: 'pointer',
